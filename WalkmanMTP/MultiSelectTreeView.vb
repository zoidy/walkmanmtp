'by: andrew weiss
'adapted from http://www.codeproject.com/KB/tree/Multiselect_Treeview.aspx
'by dr. zoidberg
Imports System
...
#Region "Selected Node(s) Properties"
        ...
        Public Property SelectedNodes() As List(Of TreeNode)
            ...
            End Get
            Set(ByVal value As List(Of TreeNode))
                ClearSelectedNodes()
                ...
                ElseIf e.KeyCode = Keys.[End] Then
                    If bShift Then
                        If m_SelectedNode.Parent Is Nothing Then
                            ...
                            If Me.Nodes.Count > 0 Then
                                SelectNode(Me.Nodes(Me.Nodes.Count - 1))
                            End If
                        Else
...
#Region "Helper Methods"
        ...
        Private Sub SelectSingleNode(ByVal node As TreeNode)
        ...
        Private Sub ToggleNode(ByVal node As TreeNode, ByVal bSelectNode As Boolean)
            If bSelectNode Then
                m_SelectedNode = node
                If Not m_SelectedNodes.Contains(node) Then
